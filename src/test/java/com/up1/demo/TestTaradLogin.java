...
public class TestTaradLogin {
	...
	public void loginSuccess() {
		...
		// return d.getTitle().toLowerCase().startsWith("จัดการข้อมูลสมาชิก");
		// }
		// });

		assertEquals(driver.getTitle(),
				"จัดการข้อมูลสมาชิก - ระบบสมาชิกตลาดดอทคอม");
		assertEquals(driver.findElement(By.className("text-red-rakuten"))
				.getText(), "somkiat_pui");
	...
	public void loginFailureWithWrongPassword() {
		...
		assertEquals(driver.findElement(By.className("box-return-message"))
				.getText(),
				"รหัสผ่านไม่ถูกต้อง กรุณากรอกรหัสผ่านใหม่");
	}
	...
	public void loginFailureWithUserNotFound() {
		...
		assertEquals(driver.findElement(By.className("box-return-message"))
				.getText(),
				"ไม่มีชื่อล๊อกอินนี้อยู่ในระบบ กรุณากรอกชื่อล๊อกอินใหม่");
	}
